...
public class Folio {
    ...
    @Column(nullable = false, precision = 19, scale = 2) private BigDecimal totalCharges;
    @Column(nullable = false, precision = 19, scale = 2) private BigDecimal totalPayment;
...
>>>>>>> dc114a833b89166f7fb2b57abae6734f127ddede
    ...
    public Folio(String confirmationNumber, String folioCode, String guestName, String roomNo,
        ...
        this.confirmationNumber = confirmationNumber; this.folioCode = folioCode;
        this.guestName = guestName; this.roomNo = roomNo; this.totalCharges = totalCharges;
        this.totalPayment = totalPayment; this.outstandingBalance = outstandingBalance;
    ...
    public void setTransactionsJson(String value) { this.transactionsJson = value; }
    public void update(String guestName, String roomNo, BigDecimal totalCharges, BigDecimal totalPayment,
        ...
        this.guestName = guestName; this.roomNo = roomNo; this.totalCharges = totalCharges;
        this.totalPayment = totalPayment; this.outstandingBalance = outstandingBalance; this.lastUpdatedAt = lastUpdatedAt;
    }
}
