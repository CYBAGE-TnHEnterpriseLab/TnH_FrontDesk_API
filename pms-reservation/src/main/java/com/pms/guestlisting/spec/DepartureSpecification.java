...
public final class DepartureSpecification {

    private DepartureSpecification() {
    }

    public static Specification<DepartureRecord> byCriteria(DepartureSearchRequestDto criteria) {
        return (root, query, cb) -> {
            ...
            predicates.add(cb.equal(root.get("checkOutDate"), criteria.getBusinessDate()));
