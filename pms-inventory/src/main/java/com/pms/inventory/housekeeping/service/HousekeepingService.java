...
import com.pms.inventory.housekeeping.dto.response.HousekeepingRoomRowResponse;
...
import com.pms.inventory.housekeeping.repository.HousekeepingRoomDayStatusHistoryRepository;
...
public class HousekeepingService {
    ...
    public HousekeepingStatusUpdateResponse updateRoomStatus(
        ...
        HousekeepingRoomDayStatus row = dayStatusRepository
                ...
                .orElseThrow(() -> new InventoryNotFoundException("Housekeeping status not found for room: " + roomNumber));
