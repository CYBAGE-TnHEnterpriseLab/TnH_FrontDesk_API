...
public class RoomTypeServiceImpl implements RoomTypeService {
    ...
    public RoomTypeResponseDTO createRoomType(RoomTypeRequestDTO request) {
        ...
        validateMasterMapping(request, request.getPropertyId());
    ...
    public RoomTypeResponseDTO updateRoomType(Long id, RoomTypeRequestDTO request) {
        ...
        validateMasterMapping(request, propertyId);
    ...
    // .orElseThrow(() -> new RoomTypeNotFoundException("Master room type not
    // found"));
    ...
    // throw new BadRequestException("Assigned master room type must belong to the
    // same property");
    // }
 
    // }
 
    private void validateMasterMapping(RoomTypeRequestDTO request, UUID propertyId) {
        ...
        System.out.println("Master property ID: " + master.getPropertyId());
        System.out.println("Request property ID: " + propertyId);
        if (!master.getPropertyId().equals(propertyId)) {
